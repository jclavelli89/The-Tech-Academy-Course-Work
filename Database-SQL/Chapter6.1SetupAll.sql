...
BEGIN
	...
	BEGIN
		...
		SELECT 'Customer found' as item, 100 as pts
			...
			BEGIN
				INSERT INTO dbTester.dbo.TestScore
				SELECT 'Customer Mark is NOT found' as item, 0 as pts
			END
			...
			BEGIN
				INSERT INTO dbTester.dbo.TestScore
				SELECT 'Customer Lee is NOT found' as item, 0 as pts
			END
			...
			BEGIN
				INSERT INTO dbTester.dbo.TestScore
				SELECT 'Customer Patricia is NOT found' as item, 0 as pts
			END
			...
			BEGIN
				INSERT INTO dbTester.dbo.TestScore
				SELECT 'Customer Mary is NOT found' as item, 0 as pts
			END


			IF ((SELECT Count(*) FROM JProCo.dbo.Customer WHERE CompanyName LIKE '%More%Tech%')=1)
			BEGIN
				INSERT INTO dbTester.dbo.TestScore
