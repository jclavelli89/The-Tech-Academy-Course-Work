...
class windowClass(wx.Frame):
    ...
    def basicGUI(self):
        ...
        exitItem.SetBitmap(wx.Bitmap('sadface.png'))
        ...
        rlyAwesomeText = wx.StaticText(panel, -1, "Customized Awesomeness", (3,30))
        rlyAwesomeText.SetForegroundColour(favColor)
